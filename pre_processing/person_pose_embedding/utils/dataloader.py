...
def normalize_lst(lst):
    ...
    :param lst: list of coordinates; sample: [x1, y1, x2, y2...] (total keypoint are 25, so length list is 50)
...
if __name__ == "__main__":
    json_di = "../data/test"
    keypoint_dataset = KeypointDataset(json_di)
    dataloader = DataLoader(keypoint_dataset, batch_size=4)
